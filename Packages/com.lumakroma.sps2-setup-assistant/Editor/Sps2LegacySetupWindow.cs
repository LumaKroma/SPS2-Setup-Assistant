...
{
    public sealed class Sps2LegacySetupWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/LumaKroma/SPS2 Setup Assistant (0.1 PoC)")]
        public static void Open()
        {
            var window = GetWindow<Sps2LegacySetupWindow>();
            window.titleContent = new GUIContent("SPS2 PoC");
