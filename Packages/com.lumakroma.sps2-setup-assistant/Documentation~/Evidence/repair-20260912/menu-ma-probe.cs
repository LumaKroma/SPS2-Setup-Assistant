...
try {
 ...
 LumaKroma.Sps2SetupAssistant.Editor.Model.FullSetupCatalog.ApplyPreset(settings,2); settings.modularAvatar=true;
 ...
 var output=System.IO.Path.GetFullPath(UnityEngine.Application.dataPath+"/../../../../issue121-definition/repair-session-6/full-build-observations.txt");
