...
try {
 ...
 LumaKroma.Sps2SetupAssistant.Editor.Model.FullSetupCatalog.ApplyPreset(settings,2); settings.localOnly=true; settings.showInternalThickness=false; settings.modularAvatar=true;
