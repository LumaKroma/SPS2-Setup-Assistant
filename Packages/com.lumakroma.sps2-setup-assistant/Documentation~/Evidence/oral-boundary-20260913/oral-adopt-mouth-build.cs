...
try {
 ...
 string active="mouth",excluded="anus"; settings.parts.Single(p=>p.id==excluded).included=false; settings.showInternalThickness=false; settings.modularAvatar=true;
